...
NDefines.NDiplomacy.BASE_GENERATE_WARGOAL_DAILY_PP = 0.4	-- Daily pp cost for generation of wargoals
NDefines.NDiplomacy.WARGOAL_WORLD_TENSION_REDUCTION = -0.75			-- Reduction of pp cost for wargoal at 100% world tension, scales linearly
NDefines.NDiplomacy.VICTORY_POINT_WORTH_FACTOR = 25-- multiplier when calcualting proince worth (surrender)
NDefines.NDiplomacy.TENSION_STATE_VALUE = 1 -- Tension value gained by annexing one state (2)
NDefines.NDiplomacy.TENSION_CB_WAR = 5								-- Amount of tension generated by a war with a CB(7)
...
NDefines.NCountry.BASE_FUEL_GAIN_PER_OIL = 0.35						-- base amount of fuel gained hourly per excess oil
NDefines.NCountry.BASE_TENSION_MAJOR_COUNTRY_INDEX = 2						-- Which major country should be considered the base country when scaling generated world tension. 0 is the country with the most factories, 1 is the second most-factories country etc. This number has to be lower than MIN_MAJOR_COUNTRIES (1)
...
NDefines.NBuildings.INFRASTRUCTURE_RESOURCE_BONUS = 0.1--changed -- multiplactive resource bonus for each level of (non damaged) infrastructure
...
NDefines.NMilitary.FIELD_EXPERIENCE_SCALE = 0.28
NDefines.NMilitary.UNIT_EXPERIENCE_PER_TRAINING_DAY = 0.005
NDefines.NMilitary.WAR_SCORE_LOSSES_RATIO = 30		
NDefines.NMilitary.CORPS_COMMANDER_DIVISIONS_CAP = 32			-- how many divisions a corps commander is limited to. 0 = inf, < 0 = blocked		
NDefines.NMilitary.FIELD_MARSHAL_DIVISIONS_CAP = 32			-- how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
NDefines.NMilitary.LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.1       -- global damage modifier... but some equipment is returned at end of battles see : EQUIPMENT_COMBAT_LOSS_FACTOR
...
NDefines.NResistance.RESISTANCE_TARGET_BASE = 30.0							-- base resistance target percentage
NDefines.NResistance.RESISTANCE_TARGET_MODIFIER_HAS_CLAIM = -10.0			-- resistance target modifier in % for states we have claim
NDefines.NResistance.RESISTANCE_TARGET_MODIFIER_IS_AT_PEACE = -15.0			-- resistance target modifier when we are at peace
NDefines.NResistance.COMPLIANCE_GROWTH_BASE = 0.1 -- base compliance grow
NDefines.NResistance.COMPLIANCE_GROWTH_HAS_CLAIM = 10 -- compliance growth buff if state has a claim
NDefines.NResistance.COMPLIANCE_GROWTH_IS_AT_PEACE = 15 -- compliance growth buff at peace
